...
/* Copyright string */
#define COPYRIGHT_MESSAGE "Copyright © 1996-2012 VLC authors and VideoLAN"
...
#define PACKAGE_STRING "vlc 2.0.4"
...
#define VERSION_MESSAGE "2.0.4 Twoflower"

/* compiler */
#define VLC_COMPILER "gcc version 4.7.2 (Ubuntu/Linaro 4.7.2-2ubuntu1) "

/* user who ran configure */
#define VLC_COMPILE_BY "pokac"

/* host which ran configure */
#define VLC_COMPILE_HOST "ubuntu.ubuntu-domain"

...
#define ROTATE90_KEY_TEXT N_("Rotate 90")
#define ROTATE90_KEY_LONGTEXT N_("Rotate the video by 90 degrees.")
...
#   define KEY_MENU_SELECT        "Alt+Shift+Enter"
    ...
    add_key( "key-rotate90", KEY_ROTATE90, ROTATE90_KEY_TEXT,
             ROTATE90_KEY_LONGTEXT, false )
